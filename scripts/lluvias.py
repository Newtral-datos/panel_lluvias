...
def subir_df_a_sheet(
    ...
    df = df.copy()
    # Evitar que Sheets “redondee” coord. o fechas:
...
if __name__ == "__main__":
    ...
    # (Opcional) log de cobertura por fecha
    ...
    if SUBIR_A_SHEETS:
        ...
        elif "subir_df_a_sheet" not in globals():
            print("AVISO: la función 'subir_df_a_sheet' no está cargada (revisa que el bloque esté pegado antes del main).")
        else:
            try:
                subir_df_a_sheet(
                    df=maestro,
